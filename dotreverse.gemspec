...
Gem::Specification.new do |spec|
  spec.name          = "dotreverse"
  spec.version       = Dotreverse::VERSION
  spec.authors       = ["anne"]
  spec.email         = ["richardson.ae@gmail.com"]

  spec.summary       = %q{Practice gem -- not for actual use: Reverses strings}
  spec.homepage      = "https://github.com/lortza/dotreverse"
  spec.license       = "MIT"
